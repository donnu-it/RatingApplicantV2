export default [
  ...
  },
  {
    ...
    profession: "Філологія. Германські мови та літератури (переклад включно), перша - англійська",
    program: "Англійська мова і переклад",
    url: "http://fim.donnu.edu.ua/uk-ua",
    koefCert: 0,
    koefCourses: 0,
    items: [
      {
  ...
  {
    department: "Іноземних мов",
    profession: "Філологія. Германські мови та літератури (переклад включно), перша - німецька",
  ...
  {
    department: "Іноземних мов",
    profession: "Філологія. Романські мови та літератури (переклад включно), перша - французська",
  ...
  },
  {
    ...
    url: "http://hist.donnu.edu.ua/uk-ua",
    koefCert: 0,
    koefCourses: 0,
    items: [
      {
  ...
  },
  {
    ...
    url: "http://math.donnu.edu.ua/uk-ua",
    koefCert: 0.1,
    koefCourses: 0,
    items: [
      {
  ...
  },
  {
    ...
    program: "Комп'ютерний аналіз даних та керування ризиками",
    url: "http://math.donnu.edu.ua/uk-ua",
    koefCert: 0.1,
    koefCourses: 0,
    items: [
  ...
  },
  {
    ...
    url: "http://phys.donnu.edu.ua/uk-ua",
    koefCert: 0,
    koefCourses: 0,
    items: [
      {
  ...
  },
  {
    ...
    url: "http://phil.donnu.edu.ua/uk-ua",
    koefCert: 0,
    koefCourses: 0,
    items: [
      {
  ...
  {
    department: "Філологічний",
    profession: "Філологія. Слов'янські мови та літератури (переклад включно), перша - російська",
    program: "Філологія (російська мова та література, переклад (російська, українська мова))",
    url: "http://phil.donnu.edu.ua/uk-ua",
    koefCert: 0,
    koefCourses: 0,
    items: [
  ...
  },
  {
    ...
    profession: "Хімія",
    program: "Хімія",
    url: "http://chem.donnu.edu.ua/uk-ua",
    koefCert: 0,
    koefCourses: 0.05,
    items: [
      {
